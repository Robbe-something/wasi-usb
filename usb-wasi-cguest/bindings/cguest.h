...
} component_usb_usb_hotplug_tuple2_event_info_t;

typedef struct {
  component_usb_usb_hotplug_tuple2_event_info_t *ptr;
  size_t len;
} component_usb_usb_hotplug_list_tuple2_event_info_t;
...
extern void component_usb_usb_hotplug_poll_events(component_usb_usb_hotplug_list_tuple2_event_info_t *ret);
